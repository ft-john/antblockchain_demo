...
let fs = require("fs")
const currentUserName = 'r' 
const userPemFolder = 'retailer';
...
program.command("ProductSold <batchNumber> <quantity>")
    .description("Sold product to enduser")
    .action(function(batchNumber, quantity){
        process.stdout.write("Sold product to enduser")
        ...
        myContract.ProductSold(batchNumber, parseInt(quantity), {from: currentUserName}, (err, output, data) => {
...
program.command("OrderSignin <orderNumber>")
    ...
    .action(function(orderNumber){
        ...
        myContract.OrderSignin(orderNumber, {from: currentUserName}, (err, output, data) => {
            if(typeof(err) != 'undefined') {
                console.log('err is:', err)
            } else {
                console.log('output is:', output.toString())
...
program.command("InventoryQuery <batchNumber>")
    .description("Query product quantity in inventory")
    .action(function(batchNumber){
        process.stdout.write("Query product quantity in inventory")
        ...
        myContract.InventoryQuery(batchNumber, {from: currentUserName}, (err, output, data) => {
            if(typeof(err) != 'undefined') {
                console.log('err is:', err)
            } else {
                console.log('output is:', output.toString())
